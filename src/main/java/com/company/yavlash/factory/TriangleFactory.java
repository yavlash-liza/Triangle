...
public class TriangleFactory {
    ...
    public List<Triangle> getTriangle(List<double[]> parameters) throws TriangleException {
        if (parameters == null) {
            logger.log(Level.ERROR, "Parameters are null in factory");
            throw new TriangleException("Invalid triangle parameters!");
        }
    ...
    private Triangle getTriangle(double[] array) throws TriangleException {
        if (array.length != VALID_AMOUNT_OF_POINTS) {
            logger.log(Level.ERROR, "Invalid count of points {} in factory", array.length);
    ...
    private Triangle getTriangle(double x1, double y1, double x2, double y2, double x3, double y3) throws TriangleException {
    ...
    public Triangle getTriangle(Point pointA, Point pointB, Point pointC) throws TriangleException {
        if (pointA == null || pointB == null || pointC == null) {
            logger.log(Level.ERROR, "Invalid parameters {}, {}, {} in factory", pointA, pointB, pointC);
